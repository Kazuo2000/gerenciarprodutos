...
fetch("http://localhost:3000/listar")
  ...
  .then((dados) => {
    ...
    for (var i = 0; i < dados[0].main.length; i++) {
      var cartao = '<div class="card mb-3 col-lg-6 col-md-6">';
      cartao += '<div class="row no-gutters">';
      cartao += '<div class="col-md-4" id="img">';
      cartao += '<img src="' + dados[0].main[i].imagem + '" class="card-img">';
      cartao += "</div>";
...
// codigo para cadastrar os dados do fomulario
function cadastrar() {
...
// codigo atualizar os dados do fomulario
function atualizar() {
...
// codigo apagar os dados do produto
function apagar() {
  var idproduto = document.getElementById("idproduto");
